  ...
  return (
    <div className="product-container">
      ...
      <div className="product-container__price-container">
        <p className="product-container__price-container__sales-price">
          $125.00
        </p>
        <p className="product-container__price-container__discount">50%</p>
      ...
      <div className="product-container__cart-container">
        <button
          ...
          className="product-container__cart-container__update-count-btn"
        >
          -
        </button>
        <p className="product-container__cart-container__quantity">
          {productCount}
        </p>
        <button
      ...
      <button
        ...
        className="product-container__add-to-cart-btn"
      >
